...
public class PilaImagenes : MonoBehaviour
    {
        ...
        [SerializeField] private Sprite imagenPredeterminada; // Imagen que se usará en todos los Push
        ...
        private readonly Stack<Sprite> pilaImagenes = new Stack<Sprite>();
        ...
        public void PushImagen()
        {
            ...
            {
                MostrarMensaje("⚠️ No se asignó ninguna imagen predeterminada.");
            }
